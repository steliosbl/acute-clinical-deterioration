...
def summary_custom(shap_values, features=None, feature_names=None, max_display=None, plot_type=None,
        ...
        for pos, i in enumerate(feature_order):
            ...
            if features is not None and colored_feature:
                ...
                pl.scatter(shaps, pos + ys, s=16, alpha=alpha, linewidth=0, zorder=3,
                           color=color if colored_feature else "#777777", rasterized=False)
